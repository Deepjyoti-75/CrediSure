...
export function FeatureCard({ title, desc }: FeatureCardProps) {
  return (
    <div className="mt-[3rem] h-[250px] w-[90vw] sm:w-[400px] p-6 bg-black border border-gray-800 rounded-lg shadow-[4px_4px_8px_2px_rgba(242,95,48,0.4)] hover:shadow-[5px_5px_10px_3px_rgba(242,95,48,0.5)] transition-shadow">
