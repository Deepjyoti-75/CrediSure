              ...
              <div className="bg-[#1A1A1A] rounded-lg p-6 border border-gray-800">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-2">
                    ...
                    <div className={`font-medium ${borrower.credit_score >= 70 ? 'text-green-400' :
                    ...
                    <div className="w-full bg-gray-700 rounded-full h-2 mt-1">
                      <div
                        className={`h-2 rounded-full ${borrower.credit_score >= 70 ? 'bg-green-500' :
              ...
              <div className="bg-[#1A1A1A] rounded-lg p-6 border border-gray-800">
                ...
                <div className="mt-6">
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2">
                    <div
                      className={`h-2 rounded-full ${borrower.new_loans_last_3_months <= 1 ? 'bg-green-500' :
