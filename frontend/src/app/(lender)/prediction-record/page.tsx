...
const sampleBorrowers: Borrower[] = [
  ...
  },
  {
    ...
    loanAmount: 1500000, // ₹15 lakh (home loan)
    loanTerm: 120,
    creditScore: 78,
    riskLevel: 'medium',
    lastAnalyzed: '2025-03-18'
  },
  {
    id: 'b007',
    name: 'Aditya Singh',
    email: 'aditya.singh@example.com',
    loanAmount: 250000, // ₹2.5 lakh (personal loan)
    loanTerm: 18,
    creditScore: 65,
    riskLevel: 'medium',
                ...
                {sortedBorrowers.length > 0 ? (
                  sortedBorrowers.map((borrower) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className={`font-medium ${borrower.creditScore >= 70 ? 'text-green-400' :
                        ...
                        <div className="w-full bg-gray-700 rounded-full h-1.5 mt-1">
                          <div
                            className={`h-1.5 rounded-full ${borrower.creditScore >= 70 ? 'bg-green-500' :
